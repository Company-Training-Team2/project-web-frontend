...
interface AuthLayoutProps {
   ...
   * fine for those, but too cramped for the Vendor Registration wizard's
   * multi-column steps. `wide` drops the two-column hero-panel grid and
   * gives children a much wider desktop canvas instead. */
  wide?: boolean;
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <section
          className={cn(
            "relative min-h-screen overflow-hidden bg-[#e9dfd1]",
            wide ? "lg:min-h-0" : "lg:min-h-[760px]",
            className
          )}
        >
          {showStatusBar ? (
