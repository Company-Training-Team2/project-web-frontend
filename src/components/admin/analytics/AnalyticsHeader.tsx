...
export default function AnalyticsHeader() {
  ...
  const stats = [
    { label: "Total Revenue", value: dashboard ? `EGP ${dashboard.totalRevenue.toLocaleString()}` : "—" },
    { label: "Total Bookings", value: dashboard ? dashboard.totalBookings.toLocaleString() : "—" },
    { label: "Total Vendors", value: dashboard ? dashboard.totalVendors.toLocaleString() : "—" },
    { label: "Total Events", value: dashboard ? dashboard.totalEvents.toLocaleString() : "—" },
  ];
